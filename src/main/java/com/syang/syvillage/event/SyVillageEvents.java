 ...
 * it reads nothing from the level, it holds nothing that is saved, and when it is interrupted
 * it finishes rather than resumes.
 *
 * <p>There was a third handler here: crouch on a bell and be told where it was still dark. It
 * came out because a player standing in their own village at night can already see that, and
 * this mod only adds what they cannot do themselves.
 */
