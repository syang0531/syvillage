...
public final class LampPlan {
    ...
    public static final Identifier LAMPS =
            Identifier.fromNamespaceAndPath(SyVillage.MODID, "light/lamps");
     ...
     * {@link #darkPosts} answers that one for {@code /syvillage light}.
     */
    ...
    private static boolean streetNear(Reach reach, BlockPos post, BlockPos bell) {
        int blocks = SyVillageConfig.LAMP_BLOCKS_BEYOND_STREET.get();
    ...
    public static List<BlockPos> darkPosts(ServerLevel level, Settlement settlement) {
        ...
        int wanted = SyVillageConfig.MIN_LIGHT_LEVEL.get();
    ...
    public static Optional<BuildRecipe> plan(ServerLevel level, Settlement settlement,
        ...
        int batch = Math.min(dark.size(), SyVillageConfig.LAMPS_PER_JOB.get());
        ...
        SyVillage.LOGGER.debug("'{}' has {} bare post(s) in phase {}; lighting {}",
