 ...
 * {@code assets/syvillage/lang/en_us.json} on the test classpath, and this lays them over it.
 */
final class TestLanguage {
    ...
    static synchronized void inject() {
        ...
        try (InputStream in = TestLanguage.class.getResourceAsStream("/assets/syvillage/lang/en_us.json")) {
            if (in == null) {
