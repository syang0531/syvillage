...
문서에 나오는 Mojang·NeoForge 클래스명과 시그니처는 **1.21.x 기준 참고값**이다. 26.2에서 이름이 바뀌었을 수 있으니 실제 매핑을 확인하고 쓴다. 문서와 실제가 다르면 **실제를 따르고 문서를 고친다.** 확인해야 할 목록은 `docs/open-questions.md` 1절에 있다.
